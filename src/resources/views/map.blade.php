{{-- Google Maps API 練習用ファイル --}}
@extends('layouts.app')

@section('content')
    <div class="map_wrapper text-center">
        <input
            id="pac-input"
            class="controls form-control d-inline w-50 mb-4"
            type="text"
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBQBvWc3bxd1kmtpr0olsWNuM-2-WGIYz0&callback=initAutocomplete&libraries=places&v=weekly"
        defer
    ></script>
